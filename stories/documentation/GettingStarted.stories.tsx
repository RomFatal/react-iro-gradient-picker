  ...
  render: () => (
    <div style={{ maxWidth: '800px', margin: '0 auto', padding: '2rem' }}>
      ...
      <div style={{ marginBottom: '3rem' }}>
        ...
        >
          <h2 style={{ margin: '0 0 1rem', color: '#fef2f2', display: 'flex', alignItems: 'center' }}>
            ⚠️ IMPORTANT: CSS Import Required
          </h2>
          <p style={{ margin: '0 0 1rem', color: '#fef2f2', fontWeight: '600' }}>
          ...
          <p style={{ margin: '1rem 0 0', color: '#fed7aa', fontSize: '14px' }}>
            ...
            Without this import, the component will not display correctly.
          </p>
        </div>
      </div>
