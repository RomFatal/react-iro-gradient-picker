    ...
    <ThemeProvider defaultTheme='dark'>
      <div
        style={{
          ...
          gap: '20px',
          minWidth: '500px',
          backgroundColor: 'var(--colorpicker-bg, #1e293b)',
...
export const RadialGradientTests: Story = {
  ...
  render: () => (
    <ThemeProvider defaultTheme='dark'>
      ...
      >
        <h3 style={{ margin: 0, color: 'var(--colorpicker-text, #f8fafc)' }}>
          🔴 Radial Gradient Test Suite
        </h3>
        ...
        {[
          ...
          },
          {
            name: 'Ellipse at Top',
            gradient:
              'radial-gradient(ellipse at top, #11998E, #38EF7D, #8BC34A)'
          },
          {
        ...
        {[
          {
            ...
            description:
              'Tests parsing of numeric-only radial gradient modifiers'
          },
          {
