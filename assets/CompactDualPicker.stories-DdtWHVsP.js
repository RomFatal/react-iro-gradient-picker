...
}`,...n.parameters?.docs?.source},description:{story:"Compact picker in a modal context",...n.parameters?.docs?.description}}};a.parameters={...a.parameters,docs:{...a.parameters?.docs,source:{originalSource:`{
  render: () => {
    return <div style={{
      display: 'flex',
      gap: '1rem',
...
}`,...a.parameters?.docs?.source},description:{story:"Multiple compact pickers side by side",...a.parameters?.docs?.description}}};const x=["Default","InModal","MultiplePickers"];export{o as Default,n as InModal,a as MultiplePickers,x as __namedExportsOrder,C as default};
